                  ...
                  <div className="flex items-center gap-1.5 mt-2 pt-2 border-t border-gray-100">
                    ...
                    {inst.contato_telefone && (
                      <>
                        ...
                        <a
                          href={`https://wa.me/55${inst.contato_telefone.replace(/\D/g, "")}`}
                          target="_blank" rel="noopener noreferrer"
                          title={t("whatsappTitle")}
                          className="w-5 h-5 rounded-full bg-green-500 hover:bg-green-600 flex items-center justify-center text-white transition-colors shrink-0"
                        >
                        ...
                        <a
                          href={`tel:+55${inst.contato_telefone.replace(/\D/g, "")}`}
                          title={t("callTitle")}
                          className="w-5 h-5 rounded-full bg-blue-500 hover:bg-blue-600 flex items-center justify-center text-white transition-colors shrink-0"
                        >
